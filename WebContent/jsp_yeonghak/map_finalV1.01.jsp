...
<body>
	...
	<div name="good"
		...
		<form name="replyform">
			<!-- <font type="hidden" id="latid" name="lntname">헬로우</font><br> 
			...
			<font size=4 id="detailcontent">헬로우</font><br><hr>
			
			<font size=6 id="replynotice"><B>세입자들의 한줄평</B></font><br><hr>
			<input type="text" id="replyid" name="replyname"> <input
				type="button" id="replyok" value="리뷰남기기"
				onClick="replydbsave()"><br>
				<hr>
			<font size=5 id="replycontent">헬로우</font><br>
	...
	<script>
     ...
     // 중심 좌표나 확대 수준이 변경됐을 때 지도 중심 좌표에 대한 주소 정보를 표시하도록 이벤트를 등록합니다
		...
		function setreply(data) {
			...
			addr ="주소 : "+addr+"<br><hr>";
			document.getElementById('replycontent').innerHTML=addr+text;
		}
