...
<body>
	...
	<p style="margin-top: -12px">
		...
		<input type="button" value="클러스터 지우깅"
			onClick="javascript:clearclusterer()">
	</p>

	<div name="good" style="width: 30%; height: 200px; float: right;">

		<form name="hello">
			<font id="latid" name="lntname">헬로우</font><br> 
			<font id="lngid">헬로우</font><br>
			<font id="addrid">헬로우</font><br> 
			<input type="button" id="latlngid" value="확인" onClick="javascript:check()"><br>
				<font id="markid">헬로우</font><br>
		</form>
